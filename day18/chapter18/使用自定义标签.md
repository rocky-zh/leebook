...
在 `src/main/webapp/WEB-INF/tags/sys` 目录下创建 `nav.tag` 文件
...
在 `src/main/webapp/WEB-INF/tags/sys` 目录下创建 `menu.tag` 文件

```
<%@ tag language="java" pageEncoding="UTF-8" %>
<%@ attribute name="parentTitle" type="java.lang.String" required="false" description=""%>
<%@ attribute name="subTitle" type="java.lang.String" required="false" description=""%>
